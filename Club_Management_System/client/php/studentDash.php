...
<body>
    <a href='studentSearch.php'>
        <button id='search' class="main-btn">
    ...
    <div class="modal-backdrop">
        <div id="modal">
            ...
            <form id='modal-form' action="../../server/handler.php" class="model-form" method='POST'>
                <div class="input">
                ...
                <input type='hidden' name='handlerMethod' value='apply'>
                <button type='submit' id='apply-button' class="apply">
    ...
    if (isset($_GET['success'])) {
        ...
        echo ("    <div id = 'modal-backdrop' class='modal-backdrop visible'>
            <div class='success-modal'>
                ...
                <div class='success-heading'>" . "<h2>" . urldecode($_GET['success']) . "</h2>" . "
                    
                </div>
                <div class='ok-btn'>
                    <form action= './studentDash.php' method = 'POST'>
        ...
        <div class='dashboard'>
            <div class='summary'>
                <div class='statistic'>
                    ...
                    <div class='value'>
                        <?php
                        $handler = new Handler();
                        echo ('<h1>' . $handler->getAvailableClubCount() . '</h1>');
                        ?>
                    </div>
                </div>
                <div class='statistic'>
                    ...
                    <div class='value'>
                        <?php
                        echo ('<h1>' . $handler->getPendingApplicationCount() . '</h1>');
                        ?>
                    </div>
                </div>
                <div class='statistic'>
                    ...
                    <div class='value'>
                        <?php
                        echo ('<h1>' . $handler->getClubCount() . '</h1>');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class='club-container'>
                ...
                <div class="club-catalog">
                    <?php
                    //$set = $handler->getAllClubInfo();
                    $registered = $handler->getRegisteredClubInfo();
                    ...
                    foreach ($registered as $key => $value) {
                        echo ("<div class='club'>
                            <div style='display:none' id = '" . $value['club_id'] . "' data-value = '" . $value['club_id'] . "'>
                             ...
                             <div class='club'><h1>" . $value['club_name'] . "<span>\n(Member)</span></h1></div>
                             <button class='view' value = '" . $value['club_id'] . "'>View</button>
                         </div>");
                    }

                    $clubs = $handler->getAllClubInfo();
