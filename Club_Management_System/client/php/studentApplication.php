...
<head>
    ...
    <link rel='stylesheet' href='../css/studentApplication.css'>
</head>
        ...
        <div class='dashboard'>
            <div class='summary'>
                <div class='statistic'>
                    ...
                    <div class='value'>
                        <?php
                        $handler = new Handler();
                        echo ('<h1>' . $handler->getApprovedApplicationCount() . '</h1>');
                        ?>
                    </div>
                </div>
                <div class='statistic'>
                ...
                <div class='statistic'>
                    ...
                    <div class='value'>
                        <?php
                        echo ('<h1>' . $handler->getRejectedApplicationCount() . '</h1>');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class='application-container'>
                ...
                <div class="application-list">
                    ...
                    <?php
                    $applications = $handler->getStudentApplications();
