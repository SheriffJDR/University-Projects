...
<body>
    <div class="modal-backdrop">
        <div id="modal">
            ...
            <form id='modal-form' action="studentView.php" class="model-form" method='POST'>
                <div class="input">
            ...
            <div class='club-container'>
                ...
                <div class="search-container">
                    <form action="../../server/validate.php" method="POST">
                        ...
                        <input type='hidden' name='validationType' value='studentSearch'>
    ...
    <script defer src='../js/studentSearch.js'></script>
</body>
