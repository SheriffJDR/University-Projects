                ...
                <div class="form-container">
                    <form action='../../server/validate.php' method='POST'>
                        <div class="label-container">
                            <label class='label-default' for='adminId' >Admin ID</label>
                        </div>
                        <div class='input-container'>
                            <input class='input-default' name='adminId'>
                        </div>
                        <div class="label-container">
                            <label class='label-default' for='password'>Password</label>
                        </div>
                        <div class='input-container'>
                            <input class='input-default' type='password'  name='password' >
                        </div>
                        <div class="login-btn">
                            <button type='submit' name='validationType' value='admin'>Login</button>
                        </div>
                    </form>
                </div>
