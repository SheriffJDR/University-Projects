            ...
            if(isset($_SESSION['rentalsErrors'])){
                ...
                <div class='row vh-30 bg-secondary rounded align-items-center justify-content-center mx-0'>
                    <div class='col-md-6 text-center p-4'>
                        ...
                        <h1 class='mb-4'>{$_SESSION['rentalsErrors']['data_retrieval']}</h1>
                        <p class='mb-4'>{$_SESSION['rentalsErrors']['error_message']}</p>
                    </div>
                </div>
            </div>
                ");
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add Rental Information to Database</h6>
                            ...
                            <form action = '../functionality/validate.php' method = 'post'>
                                <div class='mb-3'>
                                    ...
                                    <input type='text' class='form-control' id='makeInput'
                                        aria-describedby='emailHelp' name = 'customerId' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='vehicleId' class='form-label'>Vehicle Id</label>
                                    <input type='text' class='form-control' id='modelInput'
                                        aria-describedby='emailHelp' name = 'vehicleId' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='employeeId' class='form-label'>Employee Id</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'employeeId' required>
                                ...
                                <div class='mb-3'>
                                    ...
                                    <input type='date' class='form-control' aria-describedby='emailHelp' name = 'rentalStart' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='rentalEnd' class='form-label'>End of rental period</label>
                                    <input type='date' class='form-control' aria-describedby='emailHelp' name = 'rentalEnd' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='outstandingBalances' class='form-label'> Outstanding Balances</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'outstandingBalances' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='rentalRate' class='form-label'>Rental Rate</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'rentalRate' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='additionalCharges' class='form-label'>Additional Charges</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'additionalCharges' required>
                                </div>
                                <div class='form-floating mt-2'>
                                    <label for='existingDamages'>Existing Damages</label>
                                    <textarea class='form-control'  name = 'existingDamages' style='height: 150px;'></textarea>
                                </div>
                                <div class='form-floating mt-3'>
                                    <label for='newDamages'>New Damages</label>
                                    <textarea class='form-control' name = 'newDamages' style='height: 150px;'></textarea>
                                </div>
