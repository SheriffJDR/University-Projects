                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add Vehicle Information to Database</h6>
                            ...
                            <form action = '../functionality/validate.php' method = 'post'>
                                ...
                                <div class='mb-3'>
                                    ...
                                    <input type='text' class='form-control' id='vinInput'
                                        aria-describedby='emailHelp' name = 'vin' maxlength = '17' minlength = '17' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='interiorColor' class='form-label'>Interior Color</label>
                                    <input type='text' class='form-control' id='interiorColorInput'
                                        aria-describedby='emailHelp' name = 'interiorColor' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='exteriorColor' class='form-label'>Exterior Color</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'exteriorColor' id ='exteriorInput'>
                                </div>
                                <div class='mb-3'>
                                    <label for='licensePlate' class='form-label'> License Plate</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'licensePlate' id='licensePlateInput' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='odometer' class='form-label'>Odometer</label>
                                    <input type='text' class='form-control' aria-describedby='emailHelp' name = 'odometer' id='odometerInput' required>
                                </div>
                                <div class='mb-3'>
                                    <label for='availability' class='form-label'>Availability</label>
                                    <select name='availability' class ='form-select' style = 'background-color:black;' id='availabilityInput'>
                                ...
                                <div class='mb-3' id="dueDateDiv">
                                    ...
                                    <input type='date' class='form-control' aria-describedby='emailHelp' name = 'dueDate' id='dueDateInput' value = null placeholder = 'yyyy-mm-dd' required>
                                </div>
                                <input name='handlerMethod' type = 'hidden' value = 'addVehicle'>
                                <input type='hidden' name = 'validatorMethod' value = 'vehicle'>
                                <button  class=' text-center btn btn-primary'  id = 'submitVehicle'>Add</button>
                            </form>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody class ='text-nowrap'>
                                    <tr>
                                        ...
                                        <td class = 'd-flex flex-row'>
                                            ...
                                            <input type ='hidden' name = 'handlerMethod' value  = 'editVehicle'>
