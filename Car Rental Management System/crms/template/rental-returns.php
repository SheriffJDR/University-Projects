                            ...
                            <div class="row g-4">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                        ...
                                        <div class="ms-3">
                                            <p class="mb-2">Vehicles on Rental</p>
                                            <h6 class="mb-0"><?php
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                        ...
                                        <div class="ms-3">
                                            <p class="mb-2">Vehicles to be Returned Today</p>
                                            <h6 class="mb-0"><?php
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class = 'd-flex flex-row'>
                                                    ...
                                                    <button class = 'btn btn-sm btn-primary' name='rentalId' value = '{$value['rental_id']}'>Edit</button>
                                                    </form>
