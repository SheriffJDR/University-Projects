                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action = "../functionality/validate.php" method = "post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type='tel'  class='form-control' aria-describedby='emailHelp' name='phoneNumber' placeholder='###-###-####' pattern='^\d{3}-\d{3}-\d{4}$' require>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "licenseNumber" required>
                                </div>
                                <div class="mb-3">
                                    <label for="issue" class="form-label">Driver's License State/Province of Issue</label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "issue" required>
                                </div>
                                <div class="mb-3">
                                    <label for="dExpiry" class="form-label">Driver's License Expiry Date</label>
                                    <input type="date" class="form-control" aria-describedby="emailHelp" name = "dExpiry" placeholder = "yyyy-mm-dd" required>
                                </div>
                                <h6 class="mb-4">Payment Information</h6>
                                <div class="mb-3">
                                    <label for="cardNumber" class="form-label">Credit Card Number </label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "cardNumber">
                                </div>
                                <div class="mb-3">
                                    <label for="cExpiry" class="form-label">Credit Card Expiry Date </label>
                                    <input type="date" class="form-control" aria-describedby="emailHelp" name = "cExpiry" placeholder = "yyyy-mm-dd" required>
                                </div>
                                <div class="mb-3">
                                    <label for="billingAddress" class="form-label">Billing Address </label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "billingAddress" required>
                                </div>
                                <h6 class="mb-4">Rental Preferences</h6>
                                <div class="mb-3">
                                    <label for="preferredVehicle" class="form-label">Preferred Vehicle Type</label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "preferredVehicle" required>
                                </div>
                                <div class="mb-3">
                                    <label for="duration" class="form-label">Rental Duration</label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "duration" required>
                                </div>
                                <div class="mb-3">
                                    <label for="pickUp" class="form-label">Pick up Location</label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "pickUp" required>
                                </div>
                                <div class="mb-3">
                                    <label for="dropOff" class="form-label">Drop off Location</label>
                                    <input type="text" class="form-control" aria-describedby="emailHelp" name = "dropOff" required>
                                </div>
                                <input name="handlerMethod" type = "hidden" value = "addCustomer">
                                <input type='hidden' name = 'validatorMethod' value = 'customer'>
                                <button  class=" text-center btn btn-primary " type="submit" id = "submitCustomer">Add</button>
                            </form>
                        </div>
                    </div>
                </div>
